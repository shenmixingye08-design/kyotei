# FX AUTOPILOT V3 研究結果（2026-09-25 20:25 UTC、データ〜2026-09-25 19:00:00+00:00）
...
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| v3_carry_trend_7p | REJECTED | 128 | +28.1% | +2.0% | 2.86 | 0.53 | 0.73 | -8.3% | 2,433 | 32 | 0.02 | 7 | 85% | 24% | +8.0% | +18.7% | 1.90 | 7 | 53% | 0.75 | 1 | top1_trade_dependence |
| v3_carry_trend_xs | REJECTED | 179 | +50.0% | +3.2% | 1.86 | 0.50 | 0.73 | -13.3% | 3,364 | 93 | 0.03 | 9 | 69% | 30% | +29.4% | +15.9% | 1.64 | 5 | 61% | 0.70 | 3 | top5_trade_dependence, top1_trade_dependence |
| v3_carry_only | REJECTED | 28 | +46.4% | +3.0% | 5.32 | 0.39 | 0.55 | -18.8% | 18,203 | 45 | 0.00 | 14 | 62% | 36% | -4.5% | +53.3% | 3.67 | 6 | 88% | 0.59 | 2 | trades, sharpe, subperiod_not_positive, single_regime_dependence, top5_trade_dependence, top1_trade_dependence |
| v3_carry_trend_mh | REJECTED | 202 | +15.8% | +1.2% | 1.94 | 0.37 | 0.50 | -8.7% | 1,011 | 28 | 0.04 | 10 | 69% | 23% | +0.2% | +15.5% | 1.24 | 5 | 42% | 0.54 | 3 | sharpe, top5_trade_dependence, top1_trade_dependence |
...
|---|---|---|---|---|---|---|---|---|
| v3_carry_trend_xs | REJECTED | 179 | 68% | 124% | -146,320 | 0.79 | 1% | +6.8% |
| v3_carry_trend_mh | REJECTED | 202 | 60% | 110% | -20,020 | 0.91 | 27% | +7.4% |
| v3_carry_trend_7p | REJECTED | 128 | 39% | 93% | +23,199 | 1.14 | 20% | +9.1% |
...
| 2018.0 | 0.72 | 0.63 | 0.86 | 6.78 |
| 2019.0 | 0.14 | 0.05 | 0.46 | — |
| 2020.0 | 1.45 | 6.27 | 2.73 | — |
| 2021.0 | 2.63 | 14.70 | — | — |
| 2022.0 | 0.93 | 0.28 | 0.57 | 30.06 |
| 2023.0 | 48.49 | 26.39 | 194.56 | — |
| 2024.0 | 1.97 | 0.07 | 0.00 | 0.00 |
| 2025.0 | 2.54 | 7.40 | 1.59 | — |
| 2026.0 | 0.00 | 0.00 | — | — |
...
|---|---|---|---|---|---|---|---|
| v3_carry_trend_xs | AUDJPY | 29 | +21,569 | 1.20 | 41% | 108 | +14,818 |
...
| v3_carry_trend_xs | GBPJPY | 21 | +106,654 | 1.67 | 33% | 162 | +7,424 |
| v3_carry_trend_xs | GBPUSD | 25 | +64,520 | 1.92 | 44% | 76 | -10,964 |
| v3_carry_trend_xs | USDJPY | 23 | -33,051 | 0.75 | 35% | 64 | +8,115 |
| v3_carry_trend_mh | AUDJPY | 38 | +4,849 | 1.10 | 39% | 36 | +10,476 |
| v3_carry_trend_mh | AUDUSD | 39 | -580 | 0.98 | 28% | 38 | -1,644 |
| v3_carry_trend_mh | EURJPY | 26 | +26,796 | 1.85 | 35% | 20 | +5,004 |
| v3_carry_trend_mh | EURUSD | 29 | +32,820 | 2.44 | 45% | 18 | +327 |
| v3_carry_trend_mh | GBPJPY | 15 | -4,974 | 0.82 | 27% | 37 | +9,066 |
| v3_carry_trend_mh | GBPUSD | 27 | +7,399 | 1.29 | 48% | 25 | -2,957 |
| v3_carry_trend_mh | USDJPY | 28 | +138,004 | 5.97 | 46% | 17 | +35,546 |
| v3_carry_trend_7p | AUDJPY | 18 | +6,981 | 1.31 | 44% | 44 | +10,048 |
| v3_carry_trend_7p | AUDUSD | 24 | +3,297 | 1.12 | 38% | 38 | -1,499 |
| v3_carry_trend_7p | EURJPY | 16 | +25,094 | 2.28 | 50% | 27 | +4,445 |
| v3_carry_trend_7p | EURUSD | 21 | +81,803 | 3.87 | 43% | 24 | +106 |
| v3_carry_trend_7p | GBPJPY | 12 | +35,071 | 2.37 | 25% | 50 | +18,288 |
| v3_carry_trend_7p | GBPUSD | 15 | +22,156 | 2.91 | 60% | 31 | -3,982 |
| v3_carry_trend_7p | USDJPY | 22 | +137,021 | 5.29 | 27% | 19 | +33,989 |
| v3_carry_only | AUDJPY | 2 | -23,160 | 0.00 | 0% | 54 | +4,287 |
| v3_carry_only | AUDUSD | 6 | +3,892 | 1.23 | 33% | 49 | +965 |
| v3_carry_only | EURJPY | 1 | +67,071 | — | 100% | 51 | +4,044 |
| v3_carry_only | EURUSD | 5 | +67,331 | 5.00 | 20% | 17 | +29,702 |
| v3_carry_only | GBPJPY | 1 | +311,300 | — | 100% | 94 | +89,872 |
| v3_carry_only | GBPUSD | 4 | +42,814 | 4.22 | 25% | 47 | +1,749 |
| v3_carry_only | USDJPY | 9 | +40,436 | 1.85 | 22% | 47 | +48,952 |
...
| v3_carry_trend_xs | regime4h | NEUTRAL | 66 | +261,958 | 36% | 2.10 |
| v3_carry_trend_xs | regime4h | RANGE | 66 | +97,203 | 44% | 1.33 |
| v3_carry_trend_xs | regime4h | TREND | 111 | +666,913 | 37% | 2.25 |
| v3_carry_trend_xs | month_dir | DOWN | 64 | -43,143 | 39% | 0.88 |
| v3_carry_trend_xs | month_dir | FLAT | 135 | +987,805 | 36% | 2.77 |
| v3_carry_trend_xs | month_dir | UP | 58 | +143,840 | 50% | 1.74 |
| v3_carry_trend_xs | month_vol | HIGH_VOL | 76 | +230,232 | 42% | 1.53 |
| v3_carry_trend_xs | month_vol | LOW_VOL | 181 | +858,271 | 39% | 2.27 |
| v3_carry_trend_mh | regime4h | HIGH_VOL | 27 | +13,144 | 33% | 1.39 |
| v3_carry_trend_mh | regime4h | NEUTRAL | 49 | +101,098 | 49% | 3.03 |
| v3_carry_trend_mh | regime4h | RANGE | 72 | +102,757 | 35% | 2.24 |
| v3_carry_trend_mh | regime4h | TREND | 122 | +30,323 | 41% | 1.24 |
| v3_carry_trend_mh | month_dir | DOWN | 64 | +14,434 | 36% | 1.18 |
| v3_carry_trend_mh | month_dir | FLAT | 141 | +165,165 | 39% | 2.10 |
| v3_carry_trend_mh | month_dir | UP | 65 | +67,723 | 46% | 2.08 |
| v3_carry_trend_mh | month_vol | HIGH_VOL | 79 | +1,985 | 35% | 1.02 |
| v3_carry_trend_mh | month_vol | LOW_VOL | 191 | +245,336 | 42% | 2.25 |
| v3_carry_trend_7p | regime4h | HIGH_VOL | 9 | +13,221 | 56% | 2.63 |
| v3_carry_trend_7p | regime4h | NEUTRAL | 32 | +166,326 | 47% | 5.82 |
| v3_carry_trend_7p | regime4h | RANGE | 29 | +105,438 | 38% | 3.50 |
| v3_carry_trend_7p | regime4h | TREND | 58 | +26,439 | 36% | 1.32 |
| v3_carry_trend_7p | month_dir | DOWN | 29 | +27,097 | 52% | 1.66 |
| v3_carry_trend_7p | month_dir | FLAT | 71 | +225,987 | 35% | 3.62 |
| v3_carry_trend_7p | month_dir | UP | 28 | +58,340 | 43% | 2.45 |
| v3_carry_trend_7p | month_vol | HIGH_VOL | 35 | +5,126 | 37% | 1.09 |
| v3_carry_trend_7p | month_vol | LOW_VOL | 93 | +306,298 | 42% | 3.80 |
| v3_carry_only | regime4h | HIGH_VOL | 8 | +441,081 | 50% | 19.84 |
| v3_carry_only | regime4h | NEUTRAL | 3 | -13,033 | 0% | 0.00 |
| v3_carry_only | regime4h | RANGE | 5 | -23,310 | 0% | 0.00 |
| v3_carry_only | regime4h | TREND | 18 | +62,088 | 22% | 1.61 |
| v3_carry_only | month_dir | DOWN | 8 | -45,847 | 0% | 0.00 |
| v3_carry_only | month_dir | FLAT | 18 | +16,897 | 22% | 1.18 |
| v3_carry_only | month_dir | UP | 8 | +495,776 | 50% | 22.68 |
| v3_carry_only | month_vol | HIGH_VOL | 20 | +462,516 | 35% | 6.71 |
| v3_carry_only | month_vol | LOW_VOL | 14 | +4,310 | 7% | 1.05 |
...
| v3_carry_only | vol_target | 32 | +36.1% | 2.18 | 0.25 | -0.24 | 0.83 | -30.3% |
