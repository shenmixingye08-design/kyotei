# FX AUTOPILOT V4 研究結果（2026-09-26 07:29 UTC、データ〜2026-09-25 20:00:00+00:00）
...
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| v4_carry_trend_daily | REJECTED | 251 | +26.1% | +1.8% | 2.31 | 0.50 | 0.70 | -7.6% | 1,136 | 36 | 0.04 | 18 | 69% | 24% | +3.8% | +21.4% | 1.46 | 6 | 83% | 0.86 | 2 | single_regime_dependence, top1_trade_dependence |
| v4_carry_trend_h4 | REJECTED | 1945 | -2.2% | -0.2% | 0.98 | -0.05 | -0.06 | -8.5% | -7 | 15 | — | 21 | 46% | 39% | -5.7% | +3.7% | 0.93 | 3 | 100% | 0.19 | 2 | profit_factor, sharpe, positive_years, subperiod_not_positive, fragile_to_cost_2x, few_positive_pairs, single_regime_dependence, deflated_sharpe, top5_trade_dependence, top1_trade_dependence |
...
| v4_carry_trend_h4 | REJECTED | 1945 | — | — | -71,382 | 0.89 | — | +1.1% |
...
| 2021.0 | 46.26 | 0.78 | 0.85 |
| 2022.0 | 1.92 | 1.14 | 1.51 |
| 2023.0 | 7.97 | 2.17 | 1.61 |
| 2024.0 | 0.00 | 0.60 | 1.60 |
| 2025.0 | 5.03 | 3.70 | 1.29 |
...
|---|---|---|---|---|---|---|---|
| v4_carry_trend_daily | AUDJPY | 37 | +4,254 | 1.12 | 22% | 41 | +10,416 |
...
| v4_carry_trend_daily | GBPJPY | 20 | +50,788 | 3.56 | 30% | 55 | +17,889 |
| v4_carry_trend_daily | GBPUSD | 34 | +24,512 | 2.57 | 50% | 39 | -4,165 |
| v4_carry_trend_daily | USDJPY | 41 | +101,601 | 3.02 | 22% | 25 | +34,828 |
...
| v4_carry_trend_h4 | AUDUSD | 389 | -12,237 | 0.89 | 33% | 19 | -735 |
| v4_carry_trend_h4 | EURJPY | 284 | -24,883 | 0.76 | 27% | 12 | +1,967 |
| v4_carry_trend_h4 | EURUSD | 337 | +3,258 | 1.03 | 31% | 10 | +2,484 |
| v4_carry_trend_h4 | GBPJPY | 114 | -1,447 | 0.97 | 35% | 20 | +5,151 |
| v4_carry_trend_h4 | GBPUSD | 220 | -10,879 | 0.86 | 29% | 19 | -2,710 |
...
| v4_carry_trend_daily | regime4h | NEUTRAL | 76 | +275,955 | 43% | 5.82 |
...
| v4_carry_trend_daily | month_dir | FLAT | 156 | +70,800 | 31% | 1.51 |
| v4_carry_trend_daily | month_dir | UP | 73 | +252,664 | 42% | 5.20 |
| v4_carry_trend_daily | month_vol | HIGH_VOL | 73 | +36,690 | 30% | 1.53 |
| v4_carry_trend_daily | month_vol | LOW_VOL | 212 | +293,989 | 39% | 2.60 |
...
| v4_carry_trend_h4 | regime4h | RANGE | 645 | +13,802 | 35% | 1.07 |
| v4_carry_trend_h4 | regime4h | TREND | 861 | -14,806 | 27% | 0.95 |
| v4_carry_trend_h4 | month_dir | DOWN | 454 | +19,207 | 32% | 1.14 |
| v4_carry_trend_h4 | month_dir | FLAT | 1151 | -116,463 | 27% | 0.70 |
| v4_carry_trend_h4 | month_dir | UP | 442 | +83,520 | 36% | 1.60 |
| v4_carry_trend_h4 | month_vol | HIGH_VOL | 476 | -16,844 | 32% | 0.91 |
| v4_carry_trend_h4 | month_vol | LOW_VOL | 1571 | +3,108 | 29% | 1.01 |
